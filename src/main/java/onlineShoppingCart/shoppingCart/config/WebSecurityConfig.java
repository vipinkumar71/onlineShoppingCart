package onlineShoppingCart.shoppingCart.config;

import javax.servlet.http.HttpServletResponse;

import onlineShoppingCart.shoppingCart.filters.JWTRequestFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint((request, response, ex) -> {
                ...
                // only required for JS clients (react / angular) : for the pre-flight requests
